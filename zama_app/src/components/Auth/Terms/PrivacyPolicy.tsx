...
const PrivacyPolicy = ({navigation: {goBack}, route}) => {
  const handleGoback = () => {
      ...
      <ScrollView>
        <View style={{flex: 1, margin: 10}}>
          ...
          <View style={{marginLeft: 10, marginRight: 10}}>
            <Text style={{marginTop: 7, fontSize: 10, color: DARK_GRAY}}>
              - 서비스 아이디(이메일), 비밀번호
            </Text>
            <Text style={{marginTop: 7, fontSize: 10, color: DARK_GRAY}}>
          ...
          <View
            ...
            <Text style={{marginTop: 7, fontSize: 10, color: DARK_GRAY}}>
              - 회원가입 시 기입되는 개인정보(이메일, 비밀번호) 수집 사용 중
              이용자의 자발적 제공을 통한 수집
            </Text>
            <Text style={{marginTop: 7, fontSize: 10, color: DARK_GRAY}}>
          ...
          <View style={{marginLeft: 10, marginRight: 10}}>
            ...
            <Text style={{marginTop: 7, fontSize: 10, color: DARK_GRAY}}>
              - 다른 사람들을 쉽게 찾고 교류할 수 있도록 설계되었습니다. 이
          ...
          <View style={{marginLeft: 10, marginRight: 10}}>
            <Text style={{marginTop: 7, fontSize: 10, color: DARK_GRAY}}>
              ...
              확인, 가입 및 가입횟수 제한, 만14세 미만 아동 개인정보 수집 시
